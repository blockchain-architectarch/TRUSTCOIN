...
> **The project continues as [TRUSTCOIN V7 Mainnet](https://github.com/blockchain-architectarch/TRUSTCOIN-V7-Mainnet)** — a new set of contracts in a new repository.
